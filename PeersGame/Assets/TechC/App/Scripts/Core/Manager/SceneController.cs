...
namespace TechC.Scene.Manager
{
    ...
    public class SceneController : Singleton<SceneController>
    {
        ...
        public void ChangeToTitleScene() => LoadScene(SceneName.Title);

        /// <summary>インゲームシーンに遷移</summary>
        public void ChangeToInGameScene() => LoadScene(SceneName.InGame);

        /// <summary>リザルトシーンに遷移</summary>
        public void ChangeResultScene() => LoadScene(SceneName.Result);
